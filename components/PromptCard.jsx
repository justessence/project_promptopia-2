...
const PromptCard = ({ post, handleTagClick, handleEdit, handleDelete}) => {
  ...
  return (
    <div className="prompt_card">
      <div className="flex -justtify-between items-start gap-t">
        <div className="flex-1 flex justify-start items-center gap-3 curor-pointer" onClick={handleProfileClick}>
          <Image 
